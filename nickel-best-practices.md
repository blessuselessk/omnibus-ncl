...
2. **`nickel query`**: Use this to inspect types and documentation of fields in large configurations.
3. **`nickel repl`**: The best place to test complex contracts and functions.
4. **Doc Comments**: Use `| doc m%"..."%` to document your fields. It makes the configuration self-documenting for other developers (and LLMs).
